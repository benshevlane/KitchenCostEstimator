...
export const caPages: SeoPageData[] = [
  {
...
The average kitchen renovation costs **CA$22,000 to CA$60,000** in Canada in 2026, with most homeowners spending around **CA$38,000** for a mid-range renovation. Minor cosmetic updates start around CA$12,000; full luxury renovations exceed CA$100,000.

[CALCULATOR EMBED]

---

## Kitchen Renovation Cost at a Glance (Canada)

| Renovation scope | Average cost (CA$) | Best for |
|---|---|---|
| Minor refresh | CA$10,000 – CA$18,000 | Cosmetic update, no layout change |
| Mid-range renovation | CA$22,000 – CA$48,000 | New cabinets, quartz, appliances |
| Premium renovation | CA$48,000 – CA$85,000 | Layout changes, high-end finishes |
| Luxury / gut renovation | CA$85,000 – CA$160,000+ | Full structural, custom everything |

*Prices are in Canadian dollars (CA$) and exclude provincial sales tax (PST/HST/QST).*

---

## Average Kitchen Renovation Cost by Province

| Province | Mid-range kitchen renovation | Relative to national avg |
|---|---|---|
| British Columbia | CA$35,000 – CA$70,000 | +20–35% |
| Ontario | CA$30,000 – CA$62,000 | +10–20% |
| Alberta | CA$28,000 – CA$55,000 | +5–15% |
| Quebec | CA$22,000 – CA$45,000 | -5 to -10% |
| Manitoba / Saskatchewan | CA$20,000 – CA$40,000 | -10 to -15% |
| Atlantic provinces | CA$18,000 – CA$38,000 | -15 to -20% |
| National average | CA$22,000 – CA$48,000 | — |

---

## Cost Breakdown (Canada, mid-range, 10–14m²)

| Component | Cost range (CA$) | % of total |
|---|---|---|
| Cabinets (semi-custom, supply + install) | CA$7,000 – CA$18,000 | 28–38% |
| Labour (general contractor or trades) | CA$5,500 – CA$14,000 | 20–28% |
| Countertops (quartz or granite) | CA$2,200 – CA$7,500 | 8–14% |
| Appliances (full suite) | CA$3,000 – CA$9,000 | 10–16% |
| Flooring | CA$1,200 – CA$4,500 | 4–8% |
| Plumbing | CA$900 – CA$3,500 | 3–6% |
| Electrical | CA$1,000 – CA$3,500 | 3–6% |
| Backsplash | CA$600 – CA$2,200 | 2–4% |
| Sink and fixtures | CA$450 – CA$1,500 | 1–3% |
| Permits | CA$400 – CA$1,800 | 1–3% |
| Contingency (15% recommended) | CA$3,000 – CA$6,500 | 10–15% |

---

## Canadian Kitchen Cabinet Market

### Budget / big-box
**IKEA Canada, Home Depot Canada (Hampton Bay), Rona** — Flat-pack self-assembly units. IKEA's Sektion system is widely available and one of the most popular choices for mid-budget renovations.

### Mid-range
**Kitchen Craft, Aristokraft, Wolf (mid-line), Schuler** — Available through Home Depot, Rona, and independent kitchen dealers. Good quality rigid or framed cabinets with solid warranty coverage.

### Semi-custom and custom
**Menuet Cuisine (QC), Cuisines Steam (QC), Canac (QC), Almilmo (BC), local custom shops** — Each province has a strong regional custom cabinet maker network. Quebec has a highly developed kitchen manufacturing sector.

### Premium / bespoke
**Poggenpohl, Boffi, Reform (European imports), local artisan shops** — High-end European and Canadian-made cabinetry for luxury renovations.

---

## Canadian Kitchen Renovation: Key Differences from the US

**Metric measurements.** Canadian kitchen planning uses metric. Cabinet widths are typically quoted in millimetres (300mm, 400mm, 600mm) rather than US inches.

**Provincial HST/PST/GST on labour.** Tax rates on renovation labour vary by province. Ontario: 13% HST. BC: 5% GST + 7% PST. Alberta: 5% GST only. Quebec: 14.975% combined (GST + QST). Always confirm whether quotes include or exclude tax.

**Permit requirements.** Canadian building permits for kitchen renovations are required for structural changes, new plumbing, and electrical work. Requirements vary by municipality. Permits typically cost CA$400–CA$1,800.

**CMHC home renovation incentives.** The Canada Mortgage and Housing Corporation periodically offers renovation rebate programmes. Check CMHC.ca for current incentives.

---

## Kitchen Renovation Cost Per Square Foot (Canada)

| Scope | Cost per sq ft (CA$) |
|---|---|
| Budget / minor refresh | CA$120 – CA$180/sq ft |
| Mid-range | CA$180 – CA$350/sq ft |
| Premium | CA$350 – CA$550/sq ft |
| Luxury | CA$550 – CA$1,000+/sq ft |

---

## Does a Kitchen Renovation Add Value in Canada?

According to Appraisal Institute of Canada data and Realtor surveys:

- A mid-range kitchen renovation recoups **60–75% of its cost** at sale nationally
- In Toronto and Vancouver hot markets, well-executed kitchens add **8–12% of home value**
- The highest ROI renovations are mid-range (CA$30,000–CA$55,000)`,
    faqs: [
      {
        question: 'How much does a kitchen renovation cost in Canada in 2026?',
        answer: 'The national average is approximately CA$38,000 for a mid-range renovation. The range is CA$10,000 (minor refresh) to CA$160,000+ (luxury full gut). Toronto and Vancouver are significantly above the national average.',
      },
      {
        question: 'Are kitchen renovation quotes in Canada including or excluding tax?',
        answer: 'Most contractor quotes are excluding tax. Add the applicable HST/GST/QST for your province to get the tax-inclusive total. Alberta is the only major province with no provincial sales tax.',
      },
      {
        question: 'How long does a kitchen renovation take in Canada?',
        answer: 'A mid-range full renovation takes 4–8 weeks once materials arrive. Semi-custom cabinet lead times are typically 4–10 weeks in Canada. Custom cabinets can take 10–16 weeks.',
      },
      {
        question: 'Do I need a permit for a kitchen renovation in Canada?',
        answer: 'Permits are required for new plumbing runs, electrical panel upgrades, and structural changes in virtually all Canadian municipalities. Cosmetic renovations (cabinet and countertop replacement, paint, flooring) typically do not require permits.',
      },
    ],
    relatedGuides: [
      { href: '/ca', label: 'Kitchen Renovation Cost Calculator' },
      { href: '/ca/small-kitchen-renovation-cost', label: 'Small Kitchen Renovation Cost Canada' },
  ...
  {
    slug: 'small-kitchen-renovation-cost',
    locale: 'ca',
    meta: {
      title: 'Small Kitchen Renovation Cost Canada: Prices & Guide (2026)',
      description: 'Small kitchen renovations cost CA$10,000–CA$32,000 in Canada. Full cost breakdown, tips for condos and apartments, and a free calculator.',
    },
    content: `# Small Kitchen Renovation Cost Canada — 2026 Guide

A small kitchen renovation in Canada typically costs **CA$10,000 to CA$32,000**, with most homeowners spending around CA$18,000 for a mid-range result. Condominium kitchens in Toronto and Vancouver are among the most commonly renovated small kitchens in Canada.

[CALCULATOR EMBED]

---

## Small Kitchen Cost by Scope (Canada)

| Scope | Cost range (CA$, exc. tax) |
|---|---|
| Cosmetic refresh only | CA$6,000 – CA$12,000 |
| Mid-range full renovation | CA$12,000 – CA$28,000 |
| Premium renovation | CA$26,000 – CA$48,000 |
| Full gut with layout changes | CA$38,000 – CA$70,000 |

---

## Condo Kitchen Renovations in Canada

Most small kitchen renovations in Canada are in condominium units — especially in Toronto and Vancouver where condos dominate the housing market.

**Condo board approval.** Most Canadian condominium corporations require approval for any renovation affecting plumbing, electrical, or flooring. The approval process typically takes 2–4 weeks.

**Noise bylaws.** Canadian condo buildings restrict work to weekday daytime hours (typically 8am–5pm). This extends timelines vs houses.

**Elevator booking.** Material deliveries require booking the freight elevator in advance — often 1–2 weeks lead time in busy buildings.

**No modifications to suite plumbing stack.** Condo plumbing runs in shared stacks — moving the sink to a new location typically requires penetrating the concrete slab, which most condominium corporations prohibit.

---

## Small Kitchen Cost Breakdown (Canada, mid-range)

| Component | Cost range (CA$) |
|---|---|
| Cabinets (IKEA or semi-custom, 10–14 linear ft) | CA$3,500 – CA$9,000 |
| Labour (fitting) | CA$2,500 – CA$5,500 |
| Quartz countertop | CA$1,200 – CA$3,500 |
| Integrated appliances | CA$2,000 – CA$5,500 |
| Flooring (LVP or tile, 6–8m²) | CA$600 – CA$2,000 |
| Plumbing | CA$600 – CA$2,000 |
| Electrical | CA$600 – CA$2,000 |
| Backsplash | CA$400 – CA$1,500 |
| Permits | CA$300 – CA$1,200 |
| **Total (mid-range)** | **CA$12,000 – CA$28,000** |

---

## Small Kitchen Cost by Canadian City

| City | Typical small kitchen renovation (mid-range, CA$) |
|---|---|
| Toronto (condo) | CA$18,000 – CA$38,000 |
| Vancouver (condo) | CA$20,000 – CA$42,000 |
| Calgary | CA$14,000 – CA$28,000 |
| Edmonton | CA$13,000 – CA$26,000 |
| Ottawa | CA$14,000 – CA$28,000 |
| Montreal | CA$11,000 – CA$22,000 |
| Halifax | CA$10,000 – CA$20,000 |`,
    faqs: [],
    relatedGuides: [
  ...
  {
    slug: 'toronto-kitchen-renovation-cost',
    locale: 'ca',
    meta: {
      title: 'Toronto Kitchen Renovation Cost: Local Prices & Guide (2026)',
      description: 'Kitchen renovations in Toronto cost CA$28,000–CA$70,000 on average. Get a free personalised Toronto estimate with our calculator.',
    },
    content: `# Toronto Kitchen Renovation Cost — 2026 Guide

Kitchen renovation costs in Toronto average **CA$28,000 to CA$65,000** for a mid-range renovation — approximately 15–30% above the Canadian national average. The Greater Toronto Area (GTA) is Canada's highest-volume kitchen renovation market.
...
| Scope | Toronto cost (CA$, exc. tax) | Canada national avg |
|---|---|---|
| Minor refresh | CA$14,000 – CA$24,000 | CA$10,000 – CA$18,000 |
| Mid-range renovation | CA$28,000 – CA$58,000 | CA$22,000 – CA$48,000 |
| Premium renovation | CA$55,000 – CA$95,000 | CA$48,000 – CA$85,000 |
| Luxury / gut renovation | CA$90,000 – CA$175,000+ | CA$85,000 – CA$160,000+ |

*Add 13% HST to all figures for the tax-inclusive total.*

---

## Why Toronto Kitchen Renovations Cost More

**Labour rates.** Toronto trades charge CA$75–CA$120/hour for licensed plumbers and electricians, versus CA$55–CA$85/hour nationally. Kitchen fitters and general contractors run CA$65–CA$100/hour.

**Condo and permit complexity.** Over 50% of Toronto kitchen renovations are in condominium buildings. Condo board approval, permit applications, and contractor insurance requirements all add time and cost.

**HST.** Ontario's 13% HST applies to both labour and materials — higher than Alberta (5% GST only).

---

## Toronto Kitchen Renovation Cost Per Square Foot

| Scope | Toronto cost/sq ft (CA$) |
|---|---|
| Budget | CA$160 – CA$230/sq ft |
| Mid-range | CA$240 – CA$420/sq ft |
| Premium | CA$420 – CA$650/sq ft |

---

## Condo Kitchen Renovations in Toronto

**City of Toronto permits.** Kitchen renovations requiring permits are filed through Toronto Building. Online portal permits typically take 10–21 business days.

**Condo corporation approval.** File an Alteration Agreement with your condo corporation. Most Toronto buildings require 30 days' notice, submission of contractor information, and proof of WSIB clearance and liability insurance (minimum CA$2M).

**Licensed trades required.** All plumbing work must be done by a licensed plumber (Ontario College of Trades). Electrical must be done by a licensed electrician (Ontario ESA).
...
|---|---|
| Rosedale, Forest Hill, The Bridle Path | +25–40% (luxury market) |
| King West, Liberty Village, Distillery District (condos) | +10–20% |
| Midtown (Yonge & Eglinton area) | +10–20% |
| East End (Leslieville, The Beaches) | Standard |
| North York, Scarborough | Standard to -5% |
| GTA suburbs (Mississauga, Brampton, Markham) | -5 to -15% |

---

## Finding a Contractor in Toronto

- **HomeStars** (Canada's largest contractor review platform): Always check HomeStars scores before hiring in Toronto
- **Houzz Canada**: Toronto-specific listings with photos and reviews
- **RenoQuotes**: Toronto-area quote comparison platform

Always verify: WSIB clearance, CA$2M liability insurance, Ontario contractor licence, HST registration number.`,
    faqs: [
      {
        question: 'How much does a kitchen renovation cost in Toronto in 2026?',
        answer: 'Mid-range kitchen renovations in Toronto typically cost CA$28,000–CA$58,000 (exc. HST). A standard condo kitchen renovation (8–10m²) runs CA$22,000–CA$45,000.',
      },
      {
        question: 'How long does a Toronto kitchen renovation take?',
        answer: 'Allow 4–8 weeks for the renovation itself, plus 4–10 weeks for semi-custom cabinet lead times. Add 3–6 weeks for condo board approval if required.',
      },
      {
        question: 'Do I need a permit for a kitchen renovation in Toronto?',
        answer: 'Permits are required for new plumbing (including moving a sink), electrical panel changes, and structural modifications. Standard cabinet, countertop, and appliance replacement does not require a permit.',
      },
      {
        question: 'What is HomeStars and should I use it?',
        answer: 'HomeStars is Canada\'s largest home renovation review platform, similar to Angi in the US. Toronto homeowners rely heavily on HomeStars for contractor vetting. Look for contractors with a HomeStars score of 90+ and a minimum of 10 verified reviews.',
      },
    ],
    relatedGuides: [
      { href: '/ca/kitchen-renovation-cost', label: 'Full Canadian Kitchen Renovation Cost Guide' },
  ...
  {
    slug: 'vancouver-kitchen-renovation-cost',
    locale: 'ca',
    meta: {
      title: 'Vancouver Kitchen Renovation Cost: BC Prices & Guide (2026)',
      description: 'Kitchen renovations in Vancouver cost CA$32,000–CA$75,000 on average — Canada\'s most expensive market. Free calculator for a personalised BC estimate.',
    },
    content: `# Vancouver Kitchen Renovation Cost — 2026 Guide

Kitchen renovation costs in Vancouver average **CA$32,000 to CA$72,000** for a mid-range renovation — the highest in Canada. Metro Vancouver's high cost of living, constrained housing market, and strong design culture all push costs above other Canadian cities.

[CALCULATOR EMBED]

---

## Vancouver Kitchen Renovation Cost by Scope

| Scope | Vancouver cost (CA$, exc. tax) | Canada national avg |
|---|---|---|
| Minor refresh | CA$16,000 – CA$28,000 | CA$10,000 – CA$18,000 |
| Mid-range renovation | CA$32,000 – CA$65,000 | CA$22,000 – CA$48,000 |
| Premium renovation | CA$62,000 – CA$110,000 | CA$48,000 – CA$85,000 |
| Luxury / gut renovation | CA$105,000 – CA$200,000+ | CA$85,000 – CA$160,000+ |

*Add 5% GST to all figures. PST applies to materials (7%) but not labour in BC.*

---

## BC Tax on Kitchen Renovations

British Columbia has a split tax structure:

**GST (5%):** Applied to both labour and materials.
**PST (7%):** Applied to materials only, not labour.

This means BC's effective tax rate on a kitchen renovation is approximately 9–11% of the total cost — lower than Ontario's flat 13% HST.

---

## Why Vancouver Kitchen Renovations Are Canada's Most Expensive

**Labour rates.** Metro Vancouver has Canada's highest construction labour rates — licensed plumbers charge CA$95–CA$145/hour, electricians CA$90–CA$140/hour.

**Building permit costs.** City of Vancouver building permits cost CA$800–CA$3,000 depending on scope.

**Strata (condo) renovations.** Most Vancouver kitchens are in strata-titled buildings. Strata council approval adds process and time. The Strata Property Act requires response within 60 days.

**Designer culture.** Vancouver has a strong kitchen design culture, and many homeowners engage kitchen designers (CA$2,000–CA$8,000 in fees).

---

## Vancouver Neighbourhood Cost Variations

| Neighbourhood / area | Relative cost |
|---|---|
| Shaughnessy, Point Grey, West Vancouver | +30–50% |
| Kitsilano, Mount Pleasant, Main Street | +10–20% |
| East Vancouver, Burnaby | Standard |
| Surrey, Langley, Abbotsford | -10 to -20% |
| North Shore (North Vancouver, West Vancouver) | +15–30% |
| Richmond, Coquitlam | Standard to -5% |`,
    faqs: [
      {
        question: 'How much does a kitchen renovation cost in Vancouver in 2026?',
        answer: 'Mid-range kitchen renovations in Metro Vancouver typically cost CA$32,000–CA$65,000 (exc. tax). A standard 8–12m² kitchen in a Kitsilano or East Van home runs CA$28,000–CA$55,000.',
      },
      {
        question: 'Do I need a permit for a kitchen renovation in Vancouver?',
        answer: 'Yes for plumbing, electrical, and structural changes. File at the City of Vancouver\'s Development and Building Services Centre or online.',
      },
      {
        question: 'What is a strata and how does it affect my kitchen renovation?',
        answer: 'A strata corporation is the governing body of a condominium building. Under the BC Strata Property Act, you must obtain written approval from the strata council for alterations that affect the structure, plumbing, or electrical systems. Allow 4–8 weeks for approval.',
      },
    ],
    relatedGuides: [
      { href: '/ca/kitchen-renovation-cost', label: 'Full Canadian Kitchen Renovation Cost Guide' },
  ...
  {
    slug: 'calgary-kitchen-renovation-cost',
    locale: 'ca',
    meta: {
      title: 'Calgary Kitchen Renovation Cost: Alberta Prices (2026)',
      description: 'Kitchen renovations in Calgary cost CA$22,000–CA$52,000. Alberta has no PST — see how this affects your total cost and get a free calculator estimate.',
    },
    content: `# Calgary Kitchen Renovation Cost — 2026 Guide

Kitchen renovation costs in Calgary average **CA$22,000 to CA$52,000** for a mid-range renovation — above the Canadian national average but below Toronto and Vancouver. Alberta's significant tax advantage (no provincial sales tax) makes Calgary one of the better-value markets.

[CALCULATOR EMBED]

---

## Calgary Kitchen Renovation Cost by Scope

| Scope | Calgary cost (CA$, exc. tax) | Canada national avg |
|---|---|---|
| Minor refresh | CA$11,000 – CA$20,000 | CA$10,000 – CA$18,000 |
| Mid-range renovation | CA$22,000 – CA$48,000 | CA$22,000 – CA$48,000 |
| Premium renovation | CA$45,000 – CA$80,000 | CA$48,000 – CA$85,000 |
| Luxury / gut renovation | CA$75,000 – CA$140,000 | CA$85,000 – CA$160,000+ |
...
Alberta is the only major Canadian province with no provincial sales tax. All kitchen renovations are subject only to 5% GST.

On a CA$40,000 kitchen renovation:
- **Alberta (GST only):** +CA$2,000 = CA$42,000 total
- **Ontario (13% HST):** +CA$5,200 = CA$45,200 total
- **BC (GST + PST on materials):** +approximately CA$3,500 = CA$43,500 total

This saves CA$2,000–CA$4,000 vs the major eastern provinces on a typical renovation.

---

## Calgary Market Characteristics

**Oil sector correlation.** Calgary's renovation market correlates with oil prices — boom years see contractor shortages and premium pricing; quieter periods see better availability and competitive quotes.

**Newer housing stock.** Calgary's post-war and newer suburban housing stock means fewer "discovery" problems (asbestos, knob-and-tube wiring, rotted subfloors) than in Toronto or Vancouver's older housing. Contingency budgets can often be held at 10% rather than 15%.

**Community Association requirements.** Many Calgary homes are in communities with HOAs or community standards bylaws — check before any exterior-visible changes.`,
    faqs: [
      {
        question: 'How much does a kitchen renovation cost in Calgary in 2026?',
        answer: 'Mid-range kitchen renovations in Calgary cost approximately CA$22,000–CA$48,000 (exc. GST). Add 5% GST for the final total.',
      },
      {
        question: 'Does Alberta really have no PST on kitchen renovations?',
        answer: 'Correct — Alberta does not have a provincial sales tax. You pay 5% GST only on all materials and labour. This is a genuine saving of 7–9% vs Ontario and BC.',
      },
      {
        question: 'How do I find a licensed contractor in Calgary?',
        answer: 'Search HomeStars for Calgary-specific reviews, or use the Alberta Residential Contractor Network. For electrical work, verify the contractor is licensed. For gas work, a licensed Alberta gasfitter is required.',
      },
    ],
    relatedGuides: [
      { href: '/ca/kitchen-renovation-cost', label: 'Full Canadian Kitchen Renovation Cost Guide' },
